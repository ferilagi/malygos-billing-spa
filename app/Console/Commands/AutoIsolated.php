...
class AutoIsolated extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'auto:isolated';
     ...
     * @var string
     */
    protected $description = 'Auto Isolated Subscriber with parameter integrated Every Month';
