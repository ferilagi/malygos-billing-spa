            ...
            setTimeout(() => {
                if (productsData) {
                    ...
                    const product = productsData.find(
                        (product) =>
                            product.id.toString() === params.id.toString()
                    );
            ...
            setTimeout(() => {
                if (invoiceList) {
                    ...
                    const invoice = invoiceList.find(
                        (invoice) =>
                            invoice.id.toString() === params.id.toString()
                    );
                    resolve([200, invoice]);
                } else {
            ...
            setTimeout(() => {
                if (projects) {
                    ...
                    const project = projects.find(
                        (project) =>
                            project.id.toString() === params.id.toString()
                    );
                    resolve([200, project]);
                } else {
                ...
                if (productComments) {
                    ...
                    if (commentIdx > -1) {
                        if (
                            ...
                            const replyIdx = (
                                modifiedProductComments[commentIdx][
                                    "replies"
                                ] || []
                            ).findIndex(
                                (reply) =>
                                    reply.replyId.toString() ===
                                    params.replyId.toString()
                            );
                            ...
                            if (replyIdx > -1) {
                                if (
                                    ...
                                    modifiedProductComments[commentIdx][
                                        "replies"
                                    ][replyIdx]["hasLiked"] = false;
                                } else {
                                    modifiedProductComments[commentIdx][
                                        "replies"
                                    ][replyIdx]["hasLiked"] = true;
                                }
                            }
                        } else {
                            if (
                                modifiedProductComments[commentIdx]["hasLiked"]
                            ) {
                                modifiedProductComments[commentIdx][
                                    "hasLiked"
                                ] = false;
                    ...
                    if (commentIdx > -1) {
                        ...
                        if (
                            ...
                            const totalReplies =
                                modifiedComments[commentIdx]["replies"];
                            newReplyId =
                                totalReplies[totalReplies.length - 1] + 1;
                            const replyObj = {
                            ...
                            modifiedComments[commentIdx]["replies"].push({
                                ...replyObj,
                            });
                            modifiedComments[commentIdx][
                                "showAddComment"
                            ] = false;
                        } else {
                            modifiedComments[commentIdx]["replies"] = [];
