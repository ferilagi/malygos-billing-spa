                            ...
                            <CardBody>
                                ...
                                <ul className="list-inline mb-0">
                                    ...
                                    <li className="list-inline-item">
                                        ...
                                        <p className="text-muted fs-14 mb-0"><i className="mdi mdi-step-forward"></i> {item.spelled}</p>
                                    </li>
                                </ul>
                                <div className="mt-3 hstack gap-2">
                                    <span className="badge rounded-1 badge-soft-danger">{item.routers}</span>
                                    <span className="badge rounded-1 badge-soft-success">{item.prefixQueue}</span>
                                    <span className="badge rounded-1 badge-soft-warning">{item.sufixQueue}</span>
                                    <span className="badge rounded-1 badge-soft-info">{item.onlyOne}</span>
                                </div>
