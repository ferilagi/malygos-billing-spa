...
const PppData = ({ pprofiles, handlePlanEdit }) => {
                            ...
                            <CardBody>
                                ...
                                <ul className="list-inline mb-0">
                                    <li className="list-inline-item">
                                        ...
                                        <p className="text-muted fs-14 mb-1">
                                            {" "}
                                            <i className="mdi mdi-poll-box-outline"></i>{" "}
                                            {item.addressList}
                                        </p>
                                    </li>{" "}
                                ...
                                <div className="mt-3 hstack gap-2">
                                    <span className="badge rounded-1 badge-soft-primary">
                                        pppoe
                                    </span>
                                ...
                                <div className="mt-4 hstack gap-2">
                                    ...
                                    <Button
                                        onClick={() => {
                                            const pppDataEdit = item;
                                            handlePlanEdit(pppDataEdit);
                                        }}
